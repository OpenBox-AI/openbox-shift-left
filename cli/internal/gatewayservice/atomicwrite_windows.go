...
//
// The unix build uses google/renameio, which additionally fsyncs the file and its
// directory. That package declares a !windows constraint on every file and is
...
// is build-verified only in this repo, and this preserves the behavior it had.
