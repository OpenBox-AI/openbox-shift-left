...
ADR-0008, 0010 and 0011 are originals.
...
| [0004](ADR-0004-base-wire-unification.md) | Unify dev telemetry onto the base SDK wire model | Accepted (reconstructed, amended) |
