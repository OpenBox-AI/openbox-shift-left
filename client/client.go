...
// post signs and sends the body with bounded retries, returning the response
// body on a 2xx. idemKey stays constant across retries (INV-5), so a retry
// after a lost 200 re-sends the same key.
