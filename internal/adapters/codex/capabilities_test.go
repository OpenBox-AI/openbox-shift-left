...
func TestCapabilitiesProfile(t *testing.T) {
	...
	// A profile that implied "Codex cannot do per-turn" would be the exact self-
	// overstatement this repo exists to prevent, in the direction of understating
	// a competitor runtime's capability.
