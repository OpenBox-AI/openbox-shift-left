...
REPO_SLUG="${TB_REPO_SLUG:-openboxai/openbox-test}"
...
sid="$(tb_session "Stage README.md and commit it with the message 'feat: test change $run'. Use git through the Bash tool." "Bash")"
...
sid2="$(tb_session "Stage README.md and commit it with the message 'feat: second test change $run'. Use git through the Bash tool." "Bash")"
